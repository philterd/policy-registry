...
import ai.philterd.philter.registry.model.exceptions.BadRequestException;
...
public class PoliciesController {
    ...
    public @ResponseBody ResponseEntity<List<String>> getPolicyNames() throws Exception {
    ...
    public @ResponseBody ResponseEntity<String> getPolicy(@PathVariable String policyName) throws Exception {
    ...
    public void save(@RequestBody String policy) throws Exception {
    ...
    public void delete(@PathVariable String policyName) throws Exception {
