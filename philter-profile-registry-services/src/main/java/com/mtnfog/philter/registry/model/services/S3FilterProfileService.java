...
public class S3FilterProfileService implements FilterProfileService {
    ...
    public S3FilterProfileService(Properties applicationProperties, boolean testing) {
        ...
        this.bucket = applicationProperties.getProperty("filter.profiles.store.s3.bucket");
        this.prefix = applicationProperties.getProperty("filter.profiles.store.s3.prefix");
        final String region = applicationProperties.getProperty("filter.profiles.s3.store.region", "us-east-1");
    ...
    public List<String> get() {
        ...
        try {
            ...
            throw new InternalServerErrorException("Unable to get filter profile names.", ex);
    ...
    public String get(String filterProfileName) {
        ...
        try {
            ...
            throw new InternalServerErrorException("Unable to get filter profile.", ex);
    ...
    public Map<String, String> getAll() {
        ...
        try {
            ...
            throw new InternalServerErrorException("Unable to get filter profiles.", ex);
    ...
    public void save(String filterProfileJson) {
        ...
        try {
            ...
            throw new InternalServerErrorException("Unable to save filter profile.", ex);
    ...
    public void delete(String name) {
        ...
        try {
            ...
            throw new InternalServerErrorException("Unable to delete filter profile.", ex);
